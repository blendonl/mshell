...
REM  --- options ---
REM  A flag rather than a prompt on purpose: this script is also run
REM  unattended (the :wait helper below already accommodates a non-interactive
REM  console), and a question waiting on stdin would hang that.
set "WANTHELPERTASK="
for %%a in (%*) do (
